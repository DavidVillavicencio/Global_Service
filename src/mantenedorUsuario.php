...
<body>
  ...
  <script>
    ...
    //Validador de Rut Editar
    function revisarDigitoEditar(dvr) {
      dv = dvr + ""
      if (dv != '0' && dv != '1' && dv != '2' && dv != '3' && dv != '4' && dv != '5' && dv != '6' && dv != '7' && dv != '8' && dv != '9' && dv != 'k' && dv != 'K') {
        alert("Debe ingresar un digito verificador valido");
        window.document.form2.rut.focus();
        window.document.form2.rut.select();
        return false;
      }
      return true;
    }

    function revisarDigito2Editar(crut) {
      largo = crut.length;
      if (largo < 2) {
        alert("Debe ingresar el rut completo")
        window.document.form2.rut.focus();
